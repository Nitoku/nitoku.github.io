...
EditorUi.prototype.initClipboard = function()
{
	...
	mxClipboard.cut = function(graph)
	{
		...
		//console.log("console editing : " + graph.cellEditor.isContentEditing());
...
EditorUi.prototype.extractGraphModelFromEvent = function(evt)
{
	...
	console.log("extractGraphModelFromEvent : start");
	...
	if (evt != null)
	{
		...
		if (provider != null)
		{
			...
			{
				console.log("extractGraphModelFromEvent : Text");
			...
			else
			{
				...
				{
					console.log("extractGraphModelFromEvent : text/plain");
