...
var LoadImage = function(newValue, fn){
 ...
 * Constructs a new link dialog.
 */
var ImageDialog = function(editorUi, initialValue, btnLabel, fn)
{
	var div = document.createElement('div');
	mxUtils.write(div, mxResources.get('image...') + ':');
	...
	var linkInput = document.createElement('input');
	linkInput.setAttribute('value', initialValue);
	linkInput.setAttribute('placeholder', 'http://www.example.com/image.jpg');
	linkInput.setAttribute('type', 'text');
	linkInput.style.marginTop = '6px';
	linkInput.style.width = '400px';
	linkInput.style.backgroundImage = 'url(\'' + Dialog.prototype.clearImage + '\')';
	...
	mxEvent.addListener(linkInput, 'keypress', function(e)
	{
		...
		{
			editorUi.hideDialog();
			var load = new LoadImage(linkInput.value, fn);
		}
	});
